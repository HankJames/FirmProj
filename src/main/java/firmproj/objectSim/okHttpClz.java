...
public class okHttpClz implements AbstractClz{
    ...
    public okHttpClz(SootClass currentClass, SootMethod method){
        this.currentClass = currentClass;
        this.ParentMethod = method;
    }

    public okHttpClz(SootClass currentClass, SootMethod method, List<ValueContext> values){
